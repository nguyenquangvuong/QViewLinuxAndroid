...
OPENCV_MODULES:=calib3d core dnn features2d flann gapi highgui imgcodecs imgproc ml objdetect photo stitching video videoio aruco bgsegm bioinspired ccalib datasets dnn_objdetect dnn_superres dpm face fuzzy hfs img_hash world intensity_transform line_descriptor mcc optflow phase_unwrapping plot quality rapid reg rgbd saliency shape stereo structured_light superres surface_matching text tracking videostab xfeatures2d ximgproc xobjdetect xphoto
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    OPENCV_LIBS:=calib3d core dnn features2d flann gapi highgui imgcodecs imgproc ml objdetect photo stitching video videoio aruco bgsegm bioinspired ccalib datasets dnn_objdetect dnn_superres dpm face fuzzy hfs img_hash world intensity_transform line_descriptor mcc optflow phase_unwrapping plot quality rapid reg rgbd saliency shape stereo structured_light superres surface_matching text tracking videostab xfeatures2d ximgproc xobjdetect xphoto
    OPENCV_LIB_TYPE:=SHARED
else
